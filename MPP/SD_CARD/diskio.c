...
#define FCLK_SLOW() {	SPI3->CR1 = (SPI3->CR1 | SPI_BaudRatePrescaler_128); }
#define FCLK_FAST() {	SPI3->CR1 = ( SPI3->CR1 & ~SPI_BaudRatePrescaler_128 ) | SPI_BaudRatePrescaler_4; }

#define CS_HIGH()	GPIO_SetBits(GPIOA, GPIO_Pin_10)
#define CS_LOW()	GPIO_ResetBits(GPIOA, GPIO_Pin_10)
...
void SPIxENABLE(void)
{
	...
	SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_128;//256; // 72000kHz/256=281kHz < 400kHz
